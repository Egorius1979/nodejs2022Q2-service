...
export class init1659112658286 implements MigrationInterface {
    name = 'init1659112658286'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "favourites" ("id" integer NOT NULL, "artists" text NOT NULL, "albums" text NOT NULL, "tracks" text NOT NULL, CONSTRAINT "PK_173e5d5cc35490bf1de2d2d3739" PRIMARY KEY ("id"))`);
